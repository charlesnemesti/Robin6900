...
$replacements = [ordered]@{
    ...
    '<meta content="website" property="og:type">' = '<meta content="6900 outlaws are stronger than 500 knights of old finance. $ROBIN6900 lives on Robin Hood L2 — Ethereum''s layer where fees get robbed from the rich and returned to the people." property="og:description">
    ...
    '<em>($ROBIN6900 EXPLAINER FOR MID CURVE)</em>' = '<em>($ROBIN6900 EXPLAINER FOR THE PEASANT CLASS)</em>'
    ...
    'Vietnamese whale songs decoded - and they''re talking about tiny crypto tokens?' = 'Sherwood whale songs decoded — and they''re chanting $ROBIN6900?'
    ...
    '<strong>Check Robin6900 Out On CoinGecko and CoinMarketCap!<br></strong>' = '<strong>Track $ROBIN6900 Across the Realm — CoinGecko &amp; CoinMarketCap<br></strong>'
    ...
    '© 2023 by $ROBIN6900. All rights reserved!' = '© 2026 by $ROBIN6900 &amp; the Merry Men. All rights reserved!'
